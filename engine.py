...
def evaluate(data_loader, model, device, use_amp=False):
    ...
    recall = metrics.recall_score(gts, preds,average='micro')
    ...
    # print(' Accuracy:{accuracy_score.global_avg:.4f}==============  SENSI:{sen.global_avg:.4f}===========   kappa:{kappa.global_avg:.4f} ============= F1:{f1.global_avg:.4f} ============== Loss:{loss.global_avg:.4f} \============== AUC:{auc.global_avg:.4f} ============== SPEC: {spec.global_avg:.4f} ============= PPV:{ppv.global_avg:.4f} ============== NPV:{npv.global_avg:.4f}'
